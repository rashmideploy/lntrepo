...
namespace UsingCalcWebService.localhost {
    using System;
    ...
    public partial class CalcService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public CalcService() {
            this.Url = global::UsingCalcWebService.Properties.Settings.Default.UsingCalcWebService_localhost_CalcService;
        ...
        /// <remarks/>
        public void AdditionAsync(float fn, float sn) {
            this.AdditionAsync(fn, sn, null);
        }
        
        /// <remarks/>
        public void AdditionAsync(float fn, float sn, object userState) {
            ...
            this.InvokeAsync("Addition", new object[] {
                        fn,
                        sn}, this.AdditionOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/Subtraction", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        public void SubtractionAsync(float fn, float sn) {
            this.SubtractionAsync(fn, sn, null);
        }
        
        /// <remarks/>
        public void SubtractionAsync(float fn, float sn, object userState) {
            ...
            this.InvokeAsync("Subtraction", new object[] {
                        fn,
                        sn}, this.SubtractionOperationCompleted, userState);
        }
